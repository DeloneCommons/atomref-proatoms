...
numerics. Rows accepted as physical/provisional monoanion references can enter the active
v2 compute table. In addition, the source-backed Fr-U rows enter the primary
